...
switch($_GET[act]){
  ...
  default:
    ...
    while ($r=mysql_fetch_array($tampil)){
       ...
       echo "<tr>
		     ...
		     <td>$r[status]</td>
             <td align=center>
			 <a href='modul/mod_laporan/pdf_disposisi.php?id=$r[id_sMasuk]' target='_blank'><img src='images/printer.png' border='0'></a>
  ...
  case "editsMasuk":
	...
	case "disposMasuk":
		...
		$kue	= mysql_query("SELECT * FROM sMasuk WHERE id_sMasuk='$_GET[id]'");
		$r		= mysql_fetch_array($kue);
